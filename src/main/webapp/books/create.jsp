...
<form class="row g-3" method="post" enctype="multipart/form-data">
    <div class="col-md-5 offset-1">
        ...
        <input type="text" class="form-control is-valid" id="validationServer01" name="title" required>

    </div>
    <div class="col-md-4 offset-1">
        <label for="validationServer02" class="form-label">Author(s)</label>
        <input type="text" class="form-control is-valid" id="validationServer02" name="author" required>
    </div>
    <div class="col-md-4 offset-1">
        <label for="validationServer02" class="form-label">Author url</label>
        <input type="text" class="form-control is-valid" id="validationServer02" name="url" required>
    </div>
    <div class="col-md-4 offset-1">
        <label for="validationServer02" class="form-label">Pages</label>
        <input type="number" class="form-control is-valid" id="validationServer02" name="pages" required>
    </div>
    <div class="col-md-5 offset-1">
        <label for="validationServer03" class="form-label">Publisher</label>
        <input type="text" class="form-control" id="validationServer03" name="publisher" required
